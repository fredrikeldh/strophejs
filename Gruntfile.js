...
module.exports = function(grunt){
    ...
    grunt.initConfig({
        ...
        concat: {
            dist: {
                src: ['src/wrap_header.js', 'src/base64.js', 'src/sha1.js', 'src/md5.js', 'src/polyfills.js', 'src/core.js', 'src/bosh.js', 'src/websocket.js', 'src/wrap_footer.js', 'src/chromesocket.js'],
                dest: '<%= pkg.name %>'
            },
            options: {
